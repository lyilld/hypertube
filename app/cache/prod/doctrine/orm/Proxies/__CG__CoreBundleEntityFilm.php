 ...
 */
class Film extends \CoreBundle\Entity\Film implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'id', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'title', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'year', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'released', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'runtime', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'genre', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'director', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'writer', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'actors', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'plot', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'language', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'poster', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'rating', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'rated', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'idmdb', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'magnet', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'datetime', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'view', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'viewerrating', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'viewerratingnumber', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'streamlanguage', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'streamsource', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'streamquality', '' . "\0" . 'CoreBundle\\Entity\\Film' . "\0" . 'alreadysee'];
        }
    ...
    public function setMagnet($magnet)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMagnet', [$magnet]);

        return parent::setMagnet($magnet);
    }
    ...
    public function getMagnet()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMagnet', []);

        return parent::getMagnet();
    }
    ...
    public function setViewerrating($viewerrating)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setViewerrating', [$viewerrating]);

        return parent::setViewerrating($viewerrating);
    }
    ...
    public function getViewerrating()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getViewerrating', []);

        return parent::getViewerrating();
    }
    ...
    public function setViewerratingnumber($viewerratingnumber)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setViewerratingnumber', [$viewerratingnumber]);

        return parent::setViewerratingnumber($viewerratingnumber);
    }
    ...
    public function getViewerratingnumber()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getViewerratingnumber', []);

        return parent::getViewerratingnumber();
    }
